...
@section('content')
    ...
    <v-layout row wrap>
        <v-flex xs8 offset-xs2>
            ...
            <text_input label="Confirm Password" id="confirm_password"  :hint="inputs.confirm_password.msg" type="password"></text_input>

            <v-btn id="register" primary light>Register</v-btn>
        </v-flex>
    </v-layout>
            ...
            bindActions : function() {
                ...
                $register.on('click', function() {
                    ...
                    $.ajax({
                        ...
                        data : self.getData($('body'), ['username', 'password', 'confirm_password']),
                        dataType: 'json',
                        success : function(r) {
                            if(r.status != 1) {
                                alert(r.message);
